...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->email && $request->email !== $user->email) {
            Order::where('customer_email', $user->email)->update(['customer_email' => $request->email]);
        }
    ...
    public function customers(Request $request)	{
        ...
        $customers = User::leftJoinSub(
                            ...
                            ->sortable()
                            ->paginate(24);
        return view('admin.ecommerce.customers.list', ['customers' => $customers]);
    }
    ...
    public function getNewCustomers() {
        ...
        return response([
            ...
            'customers' => $new_customers->take(3)->get(['id', 'first_name', 'last_name'])
        ], 200);
    }
}
