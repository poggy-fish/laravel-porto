<template>
    <div class="product-reviews-content">
        ...
        <div class="comment-list" v-if="currentReviews.length > 0" key="exists">
            ...
            <div class="mt-2">
                <ul class="pagination justify-content-end mb-0" v-if="shouldRender">
        ...
        <p class="no-reviews" v-else key="no-exist">There are no reviews yet.</p>
        ...
        <div class="add-product-review">
            ...
            <form action="#" class="comment-form m-0" @submit.prevent="productReview">
                <p class="logged-in" v-if="isCustomer" key="customer">
                    <router-link class="text-primary" to="/pages/account/details">
                        <template v-if="reviewName">
                            Logged in as
                            {{ reviewName }}.
                        </template>
                        <template v-else>You haven't set your name. Set your name first.</template>
                    </router-link>
                    <router-link class="text-primary" to="/pages/account">Log out?</router-link>
                </p>

                <div class="rating-form">
                    <label for="rating">Your rating</label>
                    <span class="rating-stars">
                        <a class="star-1" href="#" @click.prevent="selectRating">1</a>
                        <a class="star-2" href="#" @click.prevent="selectRating">2</a>
                        <a class="star-3" href="#" @click.prevent="selectRating">3</a>
                        <a class="star-4" href="#" @click.prevent="selectRating">4</a>
                        <a class="star-5" href="#" @click.prevent="selectRating">5</a>
                    </span>
                </div>
