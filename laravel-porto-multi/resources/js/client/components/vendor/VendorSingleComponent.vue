	...
	<main class="main">
		...
		<div class="container d-md-flex skeleton-body skel-shop-products">
			<aside class="sidebar-store">
				<div class="widget widget-product-categories mb-4">
					...
					<div class="widget-body">
						<vue-tree-list :model="treeData" :default-expanded="false">
			...
			<div class="store-single">
				<component :is="storeHeaderComponent" v-bind="{user: user}"></component>
				<div class="store-single-tabs mb-2">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#products-content" role="tab">Products</a>
						</li>
					</ul>
				</div>
				<div class="store-tab-content tab-content">
					<div class="tab-pane fade show active" id="products-content" role="tabpanel">
						<template v-if="products.length > 0">
							<div class="row">
								<div class="col-sm-6 col-lg-4 col-6" v-for="(product, index) in products" :key="index">
									<div class="skel-pro skel-pro-grid skel-padding-161"></div>
									<product-one-component :product="product"></product-one-component>
								</div>
							</div>

							<nav class="toolbox toolbox-pagination w-100">
								<div class="toolbox-item toolbox-show"></div>
								<pagination-component :per-page="9" :total="totalCount"></pagination-component>
							</nav>
						</template>
