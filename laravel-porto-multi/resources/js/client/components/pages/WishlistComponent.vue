<template>
	<main class="main">
		...
		<div class="container">
			...
			<div
				class="wishlist-table-container border-0 shadow-none"
				v-else
				key="empty"
			>
				<div class="text-center">
					...
					<span class="d-block mt-2"
						>No products added to wishlist</span
					>
					<router-link to="/shop/default" class="btn btn-dark mt-2"
						>Go Shop</router-link
					>
				</div>
			</div>
