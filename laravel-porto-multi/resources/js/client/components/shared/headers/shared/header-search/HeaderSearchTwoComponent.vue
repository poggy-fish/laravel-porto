<template>
	<div class="header-search">
		<a href="#" class="search-toggle" @click="searchToggle" role="button">
			<i class="icon-magnifier"></i>
		</a>
		<form action="#" method="get" @click.stop="showSearchForm" @submit.prevent="searchProducts">
			<div class="header-search-wrapper">
				...
				/>
				<div class="select-custom" v-if="showCategory">
					<select id="cat" name="cat" v-model="category" @change="searchProducts">
				...
				<div class="live-search-list">
					<div class="autocomplete-suggestions" v-if="suggestions.length > 0" @click="goProductPage">
						<router-link
