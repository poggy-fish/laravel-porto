...
<head>
	...
	<meta name="keywords" content="Porto Laravel + Vue.js Theme" />
...
<body>
    ...
    <script>
		...
		document.cookie = 'porto-multi-user=@json(Auth::user() ? Arr::except(Auth::user()->toArray(), ["description"]) : null); path=/';
